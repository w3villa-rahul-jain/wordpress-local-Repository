...
<div class="sjb-admin-settings tab">
    ...
    <div class="sjb-section sjb-wiz-job-listing">
        <div class="sjb-content">
            ...
            <img src="<?php echo esc_url( plugin_dir_url(dirname(dirname(__FILE__))) . 'admin/images/list-company-logo.jpg'); ?>">
            <div class="sjb-form-group">
            ...
            <img src="<?php echo esc_url( plugin_dir_url(dirname(dirname(__FILE__))) . 'admin/images/list-heading.jpg' ); ?>">
            <div class="sjb-form-group">
            ...
            <img src="<?php echo esc_url( plugin_dir_url(dirname(dirname(__FILE__))) . 'admin/images/list-logo.jpg'); ?>">
        </div>
    </div>
    ...
    <div class="sjb-section sjb-wiz-theme-options">
        <div class="sjb-content">
            ...
            <img src="<?php echo esc_url( plugin_dir_url(dirname(dirname(__FILE__))) . 'admin/images/sjb-modern-layout.png'); ?>">
            <div class="sjb-form-group">
